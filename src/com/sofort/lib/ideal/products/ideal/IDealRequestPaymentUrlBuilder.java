...
public class IDealRequestPaymentUrlBuilder {
     ...
     *
     * @param url      the URL prefix (current defined sofort.com/ideal URL)
     * @param password the password defined in the control center
     * @param hash     the hash algorithm defined in the control center
