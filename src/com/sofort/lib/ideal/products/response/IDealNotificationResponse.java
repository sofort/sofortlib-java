...
public class IDealNotificationResponse {
     ...
     *
     * @param senderHolder the sender holder
     * @return the iDEAL notification response
     */
     ...
     *
     * @param senderBankName the sender bank name
     * @return the iDEAL notification response
     */
     ...
     *
     * @param senderBankBic the sender bank bic
     * @return the iDEAL notification response
     */
     ...
     *
     * @param senderCountryId the sender country id
     * @return the iDEAL notification response
     */
     ...
     *
     * @param recepientHolder the recepient holder
     * @return the iDEAL notification response
     */
     ...
     *
     * @param recepientAccountNumber the recepient account number
     * @return the iDEAL notification response
     */
     ...
     *
     * @param recepientBankCode the recepient bank code
     * @return the iDEAL notification response
     */
     ...
     *
     * @param recepientBankName the recepient bank name
     * @return the iDEAL notification response
     */
     ...
     *
     * @param recepientBankBic the recepient bank bic
     * @return the iDEAL notification response
     */
     ...
     *
     * @param recepientIban the recepient iban
     * @return the iDEAL notification response
     */
     ...
     *
     * @param recepientCountryId the recepient country id
     * @return the iDEAL notification response
     */
     ...
     *
     * @param userVariable0 the user variable0
     * @return the iDEAL notification response
     */
     ...
     *
     * @param userVariable1 the user variable1
     * @return the iDEAL notification response
     */
     ...
     *
     * @param userVariable2 the user variable2
     * @return the iDEAL notification response
     */
     ...
     *
     * @param userVariable3 the user variable3
     * @return the iDEAL notification response
     */
     ...
     *
     * @param userVariable4 the user variable4
     * @return the iDEAL notification response
     */
     ...
     *
     * @param userVariable5 the user variable5
     * @return the iDEAL notification response
     */
     ...
     *
     * @param statusModified the status modified
     * @return the iDEAL notification response
     */
