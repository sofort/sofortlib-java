...
public class SofortLibIDeal {
     ...
     *
     * @param connectionDataConfig the connection data config
     * @param dataHandler          the data handler
     * @param hashAlgorithm        the hash algorithm you defined in control center for
    ...
    public SofortLibIDeal(ConnectionConfig connectionDataConfig, DataHandler dataHandler, HashAlgorithm hashAlgorithm) {
        sofortLib = new SofortLibCommon(connectionDataConfig, dataHandler);
     ...
     * automatically.
     *
     * @param request  the request with iDEAL payment data
     * @param password the password defined in control center
     ...
     *
     * @param response the response filled with the manually received notification
     *                 data
     * @param password the password defined in control center
