...
public class PaycodeRequestRenderer implements XmlRequestRenderer {
    ...
    public void render(SofortLibRequest request, XmlElementRenderable element) {
        render((PaycodeRequest) request, element);
    }
     ...
     * element.
     *
     * @param request the paycode request
     * @param element the renderable element
     */
    public void render(PaycodeRequest request, XmlElementRenderable element) {
     ...
     *
     * @param element    the renderable element
     * @param childName  the child name for the bank account
     * @param senderBank the sender bank data
     */
     ...
     *
     * @param element       the renderable element
     * @param parentName    the parent/wrapper name
     * @param childName     the child name for each notification
