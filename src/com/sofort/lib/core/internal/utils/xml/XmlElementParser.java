...
public abstract class XmlElementParser<T> {
     ...
     * controlled.
     *
     * @param root the root node with a children
     * @param tag  name of the child nodes to parse into the list, all other
     ...
     *
     * @param childElement the XML element to parse to the defined object of type T
