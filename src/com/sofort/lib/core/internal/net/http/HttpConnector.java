...
public class HttpConnector implements Connector {
     ...
     *
     * @param connectionData connection data with target URL the connection will be opened
     *                       to.
     * @return the opened HTTP connection
     * @throws IOException thrown on call of {@link URL#openConnection()}
     */
     ...
     *
     * @param connection     opened HTTP connection
     * @param authorization  the basic HTTP authorization
     * @param postDataLength the length of the data to be posted, used for setting the
     *                       proper value of the Content-Length header
     * @throws ProtocolException thrown exception on wrong call of
